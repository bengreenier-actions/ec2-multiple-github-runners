...
| `key-name`                                                                                                                                                                   | Required if you use the `start` mode.      | EC2 KeyPair Name. <br><br> The keypair name to create the instance with.                                                                                                                                                                                                                                                              |
| `timeout-ms`                                                                                                                                                                 | Optional.                                  | Time to wait in MS before checking to see if the GH runner is registered.                                                                                                                                                                                                                                                             |
| `max-timeout-ms`                                                                                                                                                             | Optional.                                  | Max time to wait in MS for the GH runner to register before cancelling the run.                                                                                                                                                                                                                                                       |
